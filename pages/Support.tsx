    ...
    <>
      ...
      <section className="py-24 px-6 bg-narthex-cream relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-8 relative z-10">
          <motion.h2 {...fadeUp(0)} className="font-serif text-3xl md:text-4xl tracking-tight">Why This Matters</motion.h2>
          <motion.p {...fadeUp(0.1)} className="font-sans text-lg text-narthex-brown leading-relaxed">
          ...
          <motion.p {...fadeUp(0.18)} className="font-sans text-lg text-narthex-brown leading-relaxed">
      ...
      <section className="py-24 px-6 bg-narthex-black text-narthex-cream">
        <div className="max-w-7xl mx-auto">
          <motion.h2 {...fadeUp(0)} className="font-serif text-3xl text-narthex-gold text-center mb-16 tracking-tight">Your Investment Provides</motion.h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <motion.div
                key={i}
                {...fadeUp(i * 0.1)}
                className="text-center p-6 border border-narthex-gray/20 rounded-sm transition-all duration-300 hover:border-narthex-gold/40 hover:-translate-y-1"
              >
      ...
      <section className="py-24 px-6 bg-narthex-cream relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 relative z-10">
          ...
          <motion.div {...fadeUp(0)} className="bg-white p-10 border-t-4 border-narthex-green shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
          ...
          <motion.div {...fadeUp(0.1)} className="bg-white p-10 border-t-4 border-narthex-gold shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
